...
export async function createOriginalUI(): Promise<HTMLElement> {
  ...
  (async () => {
    try {
      ...
      const { getTrackersGroup } = await import('../hub/groups/trackersGroup');
      const { getItemsGroup } = await import('../hub/groups/itemsGroup');
      const { getGardenGroup } = await import('../hub/groups/gardenGroup');
      const { getConfigGroup } = await import('../hub/groups/configGroup');
      const { getToolsGroup } = await import('../hub/groups/toolsGroup');
